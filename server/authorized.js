...
router.post('/dashboard_history', async (req, res) => {
    try {
        ...
        // console.log(accounts_enquiry.data)
        // console.log(payloads)
        ...
        history.forEach(row => {
            ...
            Object.entries(details).length !== 0 && dashboard_history.push(details)
        })

        // console.log(dashboard_history)

        res.status(200).json(dashboard_history)
    } catch (error) {
        console.log(error)
